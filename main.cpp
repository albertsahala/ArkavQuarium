...
#include "src/Ikan/Guppy/Guppy.h"
#include "src/Objek/Koin/Koin.h"
#include "src/Objek/MakananIkan/MakananIkan.h"
using namespace std;
...
Siput Eka((double)(rand() % (SCREEN_WIDTH-400)) + 200);
...
int main( int argc, char* args[] )
{
    ...
    while (running && !exit) {
        ...
        if (ListPiranha.isEmpty() && ListGuppy.isEmpty() && money < 100) {
            running = false;
        }
        ...
        if (draw_help > 0) {
            draw_help -= sec_since_last;
            draw_text("Hotkey Table", 50, 350, SCREEN_HEIGHT/2 - 250, 0x21, 0x21, 0x21);
            draw_text("H - Help  ", 30, 415, SCREEN_HEIGHT/2 - 180, 0x21, 0x21, 0x21);
            draw_text("D - Change Background  ", 30, 415, SCREEN_HEIGHT/2 - 130, 0x21, 0x21, 0x21);
            draw_text("X - Quit  ", 30, 415, SCREEN_HEIGHT/2 - 80, 0x21, 0x21, 0x21);
            draw_text("P - Buy Piranha  ", 30, 415, SCREEN_HEIGHT/2 - 30, 0x21, 0x21, 0x21);
            draw_text("G - Buy Guppy  ", 30, 415, SCREEN_HEIGHT/2 + 20, 0x21, 0x21, 0x21);
            draw_text("F - Buy Fish Food  ", 30, 415, SCREEN_HEIGHT/2 + 70, 0x21, 0x21, 0x21);
            draw_text("C - Buy Egg  ", 30, 415, SCREEN_HEIGHT/2 + 120, 0x21, 0x21, 0x21);
        }
